...
VEGETABLES = ["Red_tomato", "Yellow", "Cherry", "Perfect"]
FRUITS = ["Golden", "Yellow", "Antonivka"]
...
class PestsAreTheWorst(Pests):
    def __init__(self, pests_type, quantity):
        super(PestsAreTheWorst, self).__init__(pests_type, quantity)
        self.pests_type = pests_type
        self.quantity = quantity
...
if __name__ == '__main__':
    ...
    pests = PestsAreTheWorst('worms', 3)
    tom = StarGardener('Tom', [tomato_bush, apple_tree])
    # creating only one garden instance with vegetables and fruits
    garden = Garden(["Red_tomato", "Yellow", "Cherry", "Perfect"], ["Golden", "Yellow", "Antonivka"], "Worms", "Tom")
